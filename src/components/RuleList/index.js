  ...
  return (
    <div className="backdrop">
      <section className="StartScreen">
        ...
        />
        <article className="RuleList">
          <h2>Rule List:</h2>
          <article className="rules">
            <p>
              CodeNames is a game of guessing which code names (words) in a
              set are related to a hint-word given by another player.[2]{" "}
              <br />
            ...
            <p>
              Twenty-five code name cards, each bearing a word, are laid out
            ...
            <p>
              ...
              (winning the game for that team),[3] or when one team has
